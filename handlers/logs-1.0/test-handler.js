...
class TestHandler {
    ...
    testGet(req, res, next) {
        ...
        req.finalJson = { test: "Đây là dữ liệu test của HÀM: testGet từ lớp: ./handlers/logs-1.0/test-handler.js" }
        next();
    ...
    testPost(req, res, next) {
        ...
        // mặt định chuyển tiếp sang hàm cuối cùng để trả kết quả
        req.finalJson = { test: "Đây là dữ liệu test của HÀM: testPost từ lớp: ./handlers/logs-1.0/test-handler.js" }
        next();
