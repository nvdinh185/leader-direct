...
class ApiHandler {
    ...
    getUserInfo(req, res, next) {
        ...
        req.finalJson = { test: "Đây là dữ liệu test của HÀM: getUserInfo từ lớp: ./handlers/logs-1.0/api-handler.js" }
        next();
    ...
    getQuestions(req, res, next) {
        ...
        // mặt định chuyển tiếp sang hàm cuối cùng để trả kết quả
        req.finalJson = { test: "Đây là dữ liệu test của HÀM: getQuestions từ lớp: ./handlers/logs-1.0/api-handler.js" }
        next();
    ...
    userMarkIdea(req, res, next) {
        ...
        // mặt định chuyển tiếp sang hàm cuối cùng để trả kết quả
        req.finalJson = { test: "Đây là dữ liệu test của HÀM: userMarkIdea từ lớp: ./handlers/logs-1.0/api-handler.js" }
        next();
    ...
    editUser(req, res, next) {
        ...
        // mặt định chuyển tiếp sang hàm cuối cùng để trả kết quả
        req.finalJson = { test: "Đây là dữ liệu test của HÀM: editUser từ lớp: ./handlers/logs-1.0/api-handler.js" }
        next();
    ...
    likeIdea(req, res, next) {
        ...
        // mặt định chuyển tiếp sang hàm cuối cùng để trả kết quả
        req.finalJson = { test: "Đây là dữ liệu test của HÀM: likeIdea từ lớp: ./handlers/logs-1.0/api-handler.js" }
        next();
    ...
    commentIdea(req, res, next) {
        ...
        // mặt định chuyển tiếp sang hàm cuối cùng để trả kết quả
        req.finalJson = { test: "Đây là dữ liệu test của HÀM: commentIdea từ lớp: ./handlers/logs-1.0/api-handler.js" }
        next();
    ...
    markIdea(req, res, next) {
        ...
        // mặt định chuyển tiếp sang hàm cuối cùng để trả kết quả
        req.finalJson = { test: "Đây là dữ liệu test của HÀM: markIdea từ lớp: ./handlers/logs-1.0/api-handler.js" }
        next();
