...
$BTN.on('click', () => {
    ...
    $rows.each(function () {
        ...
        // đưa vào mảng dữ liệu để xuất bản excel hoặc import theo mảng vào csdl nhé
        data.push(h);
    });

    // Output the result - mảng kết quả nhận được từ bảng dữ liệu động thêm vào
    // hoặc xuất ra kiểu json để copy sang
