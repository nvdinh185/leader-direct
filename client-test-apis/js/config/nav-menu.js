        ...
        next: [
          {
            ...
            api: {
              ...
              sample_data: `page=1&limit=5&fields=id,app,event,method,origin,url,path,ip,device,username,time&wheres={app:{$like:api*}}`,
            },
            api_params: {
              params: `page=1&limit=5&fields=id,app,event,method,origin,url,path,ip,device,username,time&wheres={app:{$like:api*}}`, 
            },
            next: "./c3-contents/show-log-events.html",
          },
          {
            active: 0,
            name: "---",
          ...
          },
          {
            ...
            api: {
              ...
              name: `Xem tần suất truy cập của một lớp IPs`,
              sample_data: `wheres={method:POST}`,
            },
            api_params: {
              params: `wheres={method:POST}`, 
            },
            next: "./c3-contents/show-log-events-ips.html",
          },
          {
            active: 0,
            ...
            api: {
              ...
              name: `Xem tần suất username truy cập`,
              sample_data: `wheres={ip:{$like:10.*}}`,
            },
            api_params: {
              params: `wheres={ip:{$like:10.*}}`, 
            },
            next: "./c3-contents/show-log-events-user.html",
          },
        ],
      },
      {
        ...
        active: 0,
        name: "Scripts",
        children_id: "run-script-menu",
        next: [
          {
            active: 0,
            name: "Truy vấn csdl CDKH_C3",
            api: {
              method: "POST",
              api_router: "/media",
              api_function: "/models/run-script/cdkh_c3",
              name: `Thực thi mệnh đề select/read trong mô hình CRUD`,
              sample_data: `select * from dual`,
            },
            api_params: {
              params: `select * 
              from dual
            ...
            next: "./c3-contents/show-run-select-cdkh.html",
          },
          {
            active: 0,
            name: "Thực thi các lệnh SQL",
            api: {
              method: "POST",
              api_router: "/media",
              api_function: "/models/run-script/:model_name",
              name: `Thực thi các mệnh đề insert|select|update|delete cho csdl SQL`,
              sample_data: `select * from dual`,
            },
            api_params: {
              params: `select * 
            ...
            next: "./c3-contents/show-run-sql-any.html",
          },
          {
            active: 0,
            name: "---",
          ...
          {
            active: 0,
            name: "Gọi hàm thực thi Oracle",
            api: {
              method: "POST",
              api_router: "/media",
              api_function: "/models/run-script/cdkh_c3",
              name: `Thực thi gọi hàm trong oracle, trả kết quả`,
              sample_data: `pkg_test.run_internal_oracle('abc','29/01/2021',1)`,
            },
            api_params: {
              params: `pkg_test.run_internal_oracle('abc','29/01/2021',1)`, 
            },
            next: "./c3-contents/show-run-function-cdkh.html",
          },
        ],
      },
    ];
