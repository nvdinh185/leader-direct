...
const TABLE_NAME = "function_granted";
const { function_granted } = require("./json-text-models");
...
class Function_granted extends DynamicModel {
    
    constructor(db) {
        super(db, TABLE_NAME, function_granted);
    }
...
module.exports = Function_granted;