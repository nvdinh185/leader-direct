...
const TABLE_NAME = "function_groups";
const { function_groups } = require("./json-text-models");
...
class Function_groups extends DynamicModel {
    
    constructor(db) {
        super(db, TABLE_NAME, function_groups);
    }
...
module.exports = Function_groups;