...
const TABLE_NAME = "api_routers";
const { api_routers } = require("./json-text-models");
...
class Api_routers extends DynamicModel {
    
    constructor(db) {
        super(db, TABLE_NAME, api_routers);
    }
