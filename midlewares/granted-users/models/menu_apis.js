...
const TABLE_NAME = "menu_apis";
const { menu_apis } = require("./json-text-models");
...
class Menu_apis extends DynamicModel {
    
    constructor(db) {
        super(db, TABLE_NAME, menu_apis);
    }
