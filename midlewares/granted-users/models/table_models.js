...
const TABLE_NAME = "table_models";
const { table_models } = require("./json-text-models");
...
class Table_models extends DynamicModel {
    
    constructor(db) {
        super(db, TABLE_NAME, table_models);
    }
