...
const TABLE_NAME = "function_apis";
const { function_apis } = require("./json-text-models");
...
class Function_apis extends DynamicModel {
    
    constructor(db) {
        super(db, TABLE_NAME, function_apis);
    }
