...
const TABLE_NAME = "ideas_marks";
const { ideas_marks } = require("./json-text-models");
...
class Ideas_marks extends DynamicModel {
    
    constructor(db) {
        // thực hiện khởi tạo mô hình lớp trên
        super(db, TABLE_NAME, ideas_marks);
    }
