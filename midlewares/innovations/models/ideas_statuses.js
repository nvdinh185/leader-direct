...
const TABLE_NAME = "ideas_statuses";
const { ideas_statuses } = require("./json-text-models");
...
class Ideas_statuses extends DynamicModel {
    
    constructor(db) {
        // thực hiện khởi tạo mô hình lớp trên
        super(db, TABLE_NAME, ideas_statuses);
    }
