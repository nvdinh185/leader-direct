...
const TABLE_NAME = "ideas_categories";
const { ideas_categories } = require("./json-text-models");
...
class Ideas_categories extends DynamicModel {
    
    constructor(db) {
        // thực hiện khởi tạo mô hình lớp trên
        super(db, TABLE_NAME, ideas_categories);
    }
...
module.exports = Ideas_categories;