...
const TABLE_NAME = "ideas_attachs";
const { ideas_attachs } = require("./json-text-models");
...
class Ideas_attachs extends DynamicModel {
    
    constructor(db) {
        // thực hiện khởi tạo mô hình lớp trên
        super(db, TABLE_NAME, ideas_attachs);
    }
