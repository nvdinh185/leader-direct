...
const TABLE_NAME = "ideas_comments";
const { ideas_comments } = require("./json-text-models");
...
class Ideas_comments extends DynamicModel {
    
    constructor(db) {
        // thực hiện khởi tạo mô hình lớp trên
        super(db, TABLE_NAME, ideas_comments);
    }
