...
const TABLE_NAME = "ideas_questions";
const { ideas_questions } = require("./json-text-models");
...
class Ideas_questions extends DynamicModel {
    
    constructor(db) {
        // thực hiện khởi tạo mô hình lớp trên
        super(db, TABLE_NAME, ideas_questions);
    }
...
module.exports = Ideas_questions;