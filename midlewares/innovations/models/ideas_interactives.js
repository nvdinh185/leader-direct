...
const TABLE_NAME = "ideas_interactives";
const { ideas_interactives } = require("./json-text-models");
...
class Ideas_interactives extends DynamicModel {
    
    constructor(db) {
        // thực hiện khởi tạo mô hình lớp trên
        super(db, TABLE_NAME, ideas_interactives);
    }
...
module.exports = Ideas_interactives;