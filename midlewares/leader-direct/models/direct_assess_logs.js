...
const TABLE_NAME = "direct_assess_logs";
const { direct_assess_logs } = require("./json-text-models");
...
class Direct_assess_logs extends DynamicModel {
    
    constructor(db) {
        // thực hiện khởi tạo mô hình lớp trên
        super(db, TABLE_NAME, direct_assess_logs);
    }
...
module.exports = Direct_assess_logs;