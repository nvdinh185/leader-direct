...
const TABLE_NAME = "direct_orgs";
const { direct_orgs } = require("./json-text-models");
...
class Direct_orgs extends DynamicModel {
    
    constructor(db) {
        // thực hiện khởi tạo mô hình lớp trên
        super(db, TABLE_NAME, direct_orgs);
    }
