...
const TABLE_NAME = "direct_executes";
const { direct_executes } = require("./json-text-models");
...
class Direct_executes extends DynamicModel {
    
    constructor(db) {
        // thực hiện khởi tạo mô hình lớp trên
        super(db, TABLE_NAME, direct_executes);
    }
...
module.exports = Direct_executes;