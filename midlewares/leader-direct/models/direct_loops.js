...
const TABLE_NAME = "direct_loops";
const { direct_loops } = require("./json-text-models");
...
class Direct_loops extends DynamicModel {
    
    constructor(db) {
        // thực hiện khởi tạo mô hình lớp trên
        super(db, TABLE_NAME, direct_loops);
    }
