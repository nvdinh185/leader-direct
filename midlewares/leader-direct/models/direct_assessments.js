...
const TABLE_NAME = "direct_assessments";
const { direct_assessments } = require("./json-text-models");
...
class Direct_assessments extends DynamicModel {
    
    constructor(db) {
        // thực hiện khởi tạo mô hình lớp trên
        super(db, TABLE_NAME, direct_assessments);
    }
...
module.exports = Direct_assessments;