...
import TaskForm from "@components/scrumBoard/TaskForm";
import Comments from "@components/scrumBoard/Comments";
        ...
        <>
          ...
          <p>
            ...
            {task.labels.map((label) => (
              <Badge key={label} status={label} text={`${label[0].toUpperCase()}${label.slice(1)}`} style={{ margin: 10 }} />
            ))}
          </p>
          <p>
