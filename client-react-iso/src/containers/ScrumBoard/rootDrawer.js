...
const DrawerRoot = ({ drawerType, drawerProps, drawerVisibility, closeDrawer, openDrawer }) => {
  if (!drawerType) {
    return null;
  }
  ...
  return (
    ...
    >
      ...
      <SpecificDrawer {...drawerProps} openDrawer={openDrawer} closeDrawer={closeDrawer} />
    </Drawer>
  );
};
