...
export default function CircleProgressWidget({ label, percent, barHeight, status, info, fontColor }) {
  return (
    <CircleProgressWidgetBar className="isoCircleProgress">
      <Progress type="circle" percent={percent} strokeWidth={barHeight} status={status} showInfo={info} />
