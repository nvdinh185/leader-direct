...
// dynamic cors handler từ csdl
const dynamicCors = require("./dynamic-cors"); // thêm dòng điều khiển core

// tạo lớp máy chủ
const expressServer = new ExpressServer(expressCfg, ddosUse, apiRoutes, socketIoCfg, failCfg, logViewer, dynamicCors);
